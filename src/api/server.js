...
const { setRandom } = require('txtgen/dist/cjs/txtgen.js');
...
export const handlers = [
  ...
  rest.get('/fakeApi/posts/:idPost', function (req, res, ctx) {
    const post = db.post.findFirst({
      where: { id: { equals: req.params.idPost } },
    });
    return res(ctx.delay(ARTIFICIAL_DELAY_MS), ctx.json(serializePost(post)));
  }),
  rest.patch('/fakeApi/posts/:idPost', (req, res, ctx) => {
  ...
  rest.get('/fakeApi/posts/:idPost/comments', (req, res, ctx) => {
    const post = db.post.findFirst({
      where: { id: { equals: req.params.idPost } },
    });
    return res(
  ...
  rest.post('/fakeApi/posts/:idPost/reactions', (req, res, ctx) => {
    const idPost = req.params.idPost;
    const reaction = req.body.reaction;
    const post = db.post.findFirst({
      where: { id: { equals: idPost } },
    });
